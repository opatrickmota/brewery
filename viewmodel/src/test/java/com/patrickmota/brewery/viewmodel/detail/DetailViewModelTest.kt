...
class DetailViewModelTest {
    ...
    @RelaxedMockK
    private lateinit var observer: Observer<com.patrickmota.brewery.viewmodel.ViewData<BreweryResponse>>

    private lateinit var capturesArguments: MutableList<com.patrickmota.brewery.viewmodel.ViewData<BreweryResponse>>
    ...
    fun setup() {
        ...
        viewModel =
            DetailViewModel(repository, testDispatcher)
    }
