...
class RateViewModelTest {
    ...
    @RelaxedMockK
    private lateinit var observer: Observer<com.patrickmota.brewery.viewmodel.ViewData<RateModel>>

    private lateinit var capturesArguments: MutableList<com.patrickmota.brewery.viewmodel.ViewData<RateModel>>
